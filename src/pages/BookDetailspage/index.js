            ...
            <div className="book-details-info">
              ...
              <div className="div-container">
                {bookData.publishedDate && (
                  <span className="date">
                    <span className="header">Published in:</span> {bookData.publishedDate}
                  </span>
                )}
                {bookData.pageCount && (
                  <span className="page-no">
                    <span className="header">no. of pages:</span> {bookData.pageCount}
                  </span>
                )}
              </div>
              {Object.keys(bookData).includes('categories') && (
              ...
              {bookData.averageRating && (
                <div className="div-container">
                  <span className="rate">
                    <span className="header">Rating:</span> {bookData.averageRating}
                  </span>
                  <span className="rate-counter">
                    <span className="header">no. of rating: </span>
